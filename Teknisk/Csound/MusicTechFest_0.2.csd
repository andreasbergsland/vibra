...
kTrigStop		ctrl7		2, 35, 0, 1
if	trigger:k(kTrigStop,0.5,1)==1	then
turnoff2	22, 0, 1
endif
...
outch(1, aChordL*0.5*kfadeout+arevL*0.25*kfadeout) 
outch(2, aChordR*0.5*kfadeout+arevR*0.25*kfadeout) 
...
kminrate		linseg	0, 60, 3
kmaxrate		linseg	2,60,	4
...
aVowel0		mincer	atimp1, gkMyo1_EMG_port[0], kPitch1,      giTabNums[kind1], 1
aVowel1		mincer	atimp2, gkMyo1_EMG_port[1], kPitch1,      giTabNums[kind2], 1
aVowel2		mincer	atimp3, gkMyo1_EMG_port[2], kPitch2*0.88, giTabNums[kind3], 1
aVowel3		mincer	atimp4, gkMyo1_EMG_port[3], kPitch2*0.88, giTabNums[kind4], 1
aVowel4		mincer	atimp5, gkMyo1_EMG_port[4], kPitch1*0.92, giTabNums[kind5], 1
aVowel5		mincer	atimp6, gkMyo1_EMG_port[5], kPitch1*0.92, giTabNums[kind6], 1
aVowel6		mincer	atimp7, gkMyo1_EMG_port[6], kPitch2*1.12, giTabNums[kind7], 1
aVowel7		mincer	atimp8, gkMyo1_EMG_port[7], kPitch2*1.12, giTabNums[kind8], 1

aVowel10		mincer	atimp11, gkMyo2_EMG_port[0], kPitch1, giTabNums[kind9], 1
aVowel11		mincer	atimp12, gkMyo2_EMG_port[1], kPitch1, giTabNums[kind10], 1
aVowel12		mincer	atimp13, gkMyo2_EMG_port[2], kPitch2, giTabNums[kind11], 1
aVowel13		mincer	atimp14, gkMyo2_EMG_port[3], kPitch2, giTabNums[kind12], 1
aVowel14		mincer	atimp15, gkMyo2_EMG_port[4], kPitch1, giTabNums[kind13], 1
aVowel15		mincer	atimp16, gkMyo2_EMG_port[5], kPitch1, giTabNums[kind14], 1
aVowel16		mincer	atimp17, gkMyo2_EMG_port[6], kPitch2, giTabNums[kind15], 1
aVowel17		mincer	atimp18, gkMyo2_EMG_port[7], kPitch2, giTabNums[kind16], 1

aChordL		sum	aVowel0,  aVowel1,  aVowel2,  aVowel3, aVowel4, aVowel5, aVowel6, aVowel7
aChordR		sum	aVowel10, aVowel11, aVowel12, aVowel13, aVowel14, aVowel15, aVowel16, aVowel17

kfadeexp		expsegr	1, p3, 1, 1, 4

arevL, arevR	reverbsc	aChordL, aChordR, 0.88, 9000, sr, 1.4
outch(1, aChordL*0.5*kfadeexp+arevL*0.25)
outch(2, aChordR*0.5*kfadeexp+arevR*0.25)
