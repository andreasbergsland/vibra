...
if	gkTesting == 1	then
gkMyo1_euler	OSClistenArray	giMyoTest, "/myo/1/imu/euler", "fff"
endif
...
gkSensors[]		init		10
if	gkTesting == 1	then
gkSensors		OSClistenArray	giMyoTest, "/myo/1/imu/raw", "ffffffffff"
gkMyo1_quats	slicearray		gkSensors,	6, 9
endif
...
if	gkTesting	==	1	then
gkMyo1_EMG_bf	OSClistenArray	giMyoTest, "/myo/1/emg/bfilt", "ffffffff"
endif
