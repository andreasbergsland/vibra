...
; Start instrument 4 (sound producing instrument)
;iPreset		=		2
;schedule		4, 0, $ALWAYSON, 1, iPreset, 2
...
outs		gaSend[0]+ gaSend[1]+gaSend[2]+gaSend[3], gaSend[4]+gaSend[5]+gaSend[6]+gaSend[7] 
...
i "GirlGeek_AChu" 0	$ALWAYSON	1	4	1
;i500		0		$ALWAYSON
i1000		0		$ALWAYSON
